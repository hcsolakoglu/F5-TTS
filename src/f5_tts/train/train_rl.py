...
tokenizer_path = None  # path to custom vocab.txt when tokenizer == "custom"
dataset_name = "RL_ZH"
...
epochs = 5  # linear decay; epochs control the slope
...
def main():
    ...
    if tokenizer != "custom":
        local_tokenizer_path = dataset_name
    vocab_char_map, vocab_size = get_tokenizer(local_tokenizer_path, tokenizer)
