...
class CFM(nn.Module):
    ...
    def _prepare_training_inputs(self, inp, text, lens, rand_span_mask=None):
    ...
    def forward(
        ...
        *,
        ...
        # A presampled rand_span_mask (global-masked-mean training) is validated and
        # reused instead of being resampled inside the preparation step.
        x1, text, mask, rand_span_mask, x0, time, drop_audio_cond, drop_text = self._prepare_training_inputs(
            inp, text, lens, rand_span_mask=rand_span_mask
        )
