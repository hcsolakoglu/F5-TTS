...
CANDIDATES: dict[str, dict[str, Any]] = {
    ...
    "compiled_bucket64_r30_align": {
        "compile": True,
        "mode": None,
        "options": None,
        "mark_step": False,
        "bucket_mel_size": 64,
        "bucket_max_padding_ratio": 0.30,
        "align_text_len_to_mel": True,
        "compile_mark_dynamic": False,
    },
    "compiled_bucket64_r30_align_markdyn": {
        "compile": True,
        "mode": None,
        "options": None,
        "mark_step": False,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--candidates",
        default="compiled_bucket64_r30_align,compiled_bucket64_r30_align_markdyn",
    )
